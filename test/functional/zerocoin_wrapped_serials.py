#!/usr/bin/env python3
# Copyright (c) 2019 The Pictureex Core developers
...
from fake_stake.base_test import pictureex_FakeStakeTest

class zpicwrappedSerialsTest(pictureex_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zpics..." % DENOM_TO_USE)
