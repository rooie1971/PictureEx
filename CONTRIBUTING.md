Contributing to Pictureex Core
============================

The Pictureex Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Pictureex Core project, and is not to be
confused with overall Pictureex Network Protocol consensus changes.

Whether a pull request is merged into Pictureex Core rests with the project merge
...
Patches that change pictureex consensus rules are considerably more involved than
...
Where a patch set proposes to change the Pictureex consensus, it must have been
...
The project leader is the release manager for each Pictureex Core release.
