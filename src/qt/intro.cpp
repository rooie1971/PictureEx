...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Pictureex Core"),
     ...
     * override -datadir in the pictureex.conf file in the default data directory
     * (to be consistent with pictureexd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
