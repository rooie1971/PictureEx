...
/** Utility functions used by the pictureex Qt UI.
 */
namespace GUIUtil
{
...
// Render pictureex addresses in monospace font
...
// Parse "pictureex:" URI into recipient object, return true on successful parsing
