...
/* pictureex GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Pictureex"
#define QAPP_ORG_DOMAIN "pic.io"
#define QAPP_APP_NAME_DEFAULT "pictureex-Qt"
#define QAPP_APP_NAME_TESTNET "pictureex-Qt-testnet"
