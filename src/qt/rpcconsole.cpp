                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzpicPathCustom = GetArg("-zpicbackuppath", "");
    ...
    if(!strzpicPathCustom.empty()) {
        ui->wallet_customzpicbackuppath->setText(QString::fromStdString(strzpicPathCustom));
        ui->wallet_customzpicbackuppath_label->setVisible(true);
        ui->wallet_customzpicbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzpicPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Pictureex RPC console.") + "<br>" +
