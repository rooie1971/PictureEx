...
#ifndef pictureex_zpicWALLET_H
#define pictureex_zpicWALLET_H
...
public:
    CzpicWallet(std::string strWalletFile);
    ...
    void GenerateDeterministiczpic(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedTozpic(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
