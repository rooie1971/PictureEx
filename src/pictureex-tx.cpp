...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Pictureex Core pictureex-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  pictureex-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pictureex transaction") + "\n" +
                               "  pictureex-tx [options] -create [commands]   " + _("Create hex-encoded pictureex transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded pictureex transaction
