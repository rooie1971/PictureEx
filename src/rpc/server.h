...
/**
 * pictureex RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzpicseed(const UniValue& params, bool fHelp);
extern UniValue getzpicseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzpic(const UniValue& params, bool fHelp);
extern UniValue dzpicstate(const UniValue& params, bool fHelp);
