...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop pictureex server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "pictureex server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* pictureex features */
    //    {"pictureex", "masternode", &masternode, true, true, false},
        {"pictureex", "listmasternodes", &listmasternodes, true, true, false},
        {"pictureex", "getmasternodecount", &getmasternodecount, true, true, false},
        {"pictureex", "masternodeconnect", &masternodeconnect, true, true, false},
        {"pictureex", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"pictureex", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"pictureex", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"pictureex", "masternodecurrent", &masternodecurrent, true, true, false},
        {"pictureex", "masternodedebug", &masternodedebug, true, true, false},
        {"pictureex", "startmasternode", &startmasternode, true, true, false},
        {"pictureex", "createmasternodekey", &createmasternodekey, true, true, false},
        {"pictureex", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"pictureex", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"pictureex", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"pictureex", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"pictureex", "getmasternodescores", &getmasternodescores, true, true, false},
        {"pictureex", "preparebudget", &preparebudget, true, true, false},
        {"pictureex", "submitbudget", &submitbudget, true, true, false},
        {"pictureex", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"pictureex", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"pictureex", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"pictureex", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"pictureex", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"pictureex", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"pictureex", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"pictureex", "checkbudgets", &checkbudgets, true, true, false},
        {"pictureex", "mnsync", &mnsync, true, true, false},
        {"pictureex", "spork", &spork, true, true, false},
        {"pictureex", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzpicseed", &getzpicseed, false, false, true},
        {"zerocoin", "setzpicseed", &setzpicseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzpic", &searchdzpic, false, false, true},
        {"zerocoin", "dzpicstate", &dzpicstate, false, false, true},
...
{
    return "> pictureex-cli " + methodname + " " + args + "\n";
}
