...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/pictureex-cli.cpp \
           src/pictureex-tx.cpp \
           src/pictureex.cpp \
           src/db.cpp \
           ...
           src/qt/pictureex.cpp \
           src/qt/pictureexstrings.cpp \
...
RESOURCES += src/qt/pictureex.qrc src/qt/pictureex_locale.qrc

TRANSLATIONS += src/qt/locale/pictureex_bg.ts \
                src/qt/locale/pictureex_de.ts \
                src/qt/locale/pictureex_en.ts \
                src/qt/locale/pictureex_es.ts \
                src/qt/locale/pictureex_fi.ts \
                src/qt/locale/pictureex_fr.ts \
                src/qt/locale/pictureex_it.ts \
                src/qt/locale/pictureex_ja.ts \
                src/qt/locale/pictureex_pl.ts \
                src/qt/locale/pictureex_pt.ts \
                src/qt/locale/pictureex_ru.ts \
                src/qt/locale/pictureex_sk.ts \
                src/qt/locale/pictureex_sv.ts \
                src/qt/locale/pictureex_vi.ts \
                src/qt/locale/pictureex_zh_CN.ts \
                src/qt/locale/pictureex_zh_TW.ts
