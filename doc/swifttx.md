...
This mechanism has been integrated into Bitcore-Node-pictureex which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/pictureex-Project/insight-api-pictureex#web-socket-api](https://github.com/pictureex-Project/insight-api-pictureex#web-socket-api) 
* API: [https://github.com/pictureex-Project/insight-api-pictureex#swifttx-transactions](https://github.com/pictureex-Project/insight-api-pictureex#swifttx-transactions) 
...
By default, the Pictureex Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Pictureex Core daemon:
