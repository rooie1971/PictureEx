...
In order to support loading of multiple wallets in pictureex-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is pictureex.cpp.
...
Changes to pictureex.cpp
----------------------
pictureex.cpp is the entry point into pictureex-qt, and as such, will require some minor modifications to provide hooks for
